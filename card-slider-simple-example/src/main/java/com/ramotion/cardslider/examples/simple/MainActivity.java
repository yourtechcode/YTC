...
import com.diegodobelo.expandinganimlib.AndroidActivity;


import com.diegodobelo.expandinganimlib.HackingActivity;
import com.diegodobelo.expandinganimlib.IosActivity;
import com.diegodobelo.expandinganimlib.KotlinActivity;
import com.diegodobelo.expandinganimlib.PhotoActivity;
import com.diegodobelo.expandinganimlib.PythonActivity;
import com.diegodobelo.expandinganimlib.ReactActivity;
import com.diegodobelo.expandinganimlib.SketchActivity;
import com.diegodobelo.expandinganimlib.UnityActivity;
import com.diegodobelo.expandinganimlib.WebActivity;
...
public class MainActivity extends Activity {
    ...
    private final int[] pics = {R.drawable.androidjava, R.drawable.iosswift, R.drawable.androidkotlin, R.drawable.webdevelopments, R.drawable.reactnativvew,R.drawable.unity3d,R.drawable.pstut,R.drawable.swiftr,R.drawable.ethicalhacking,R.drawable.pythobl};
    ...
    private final int[] descriptions = {R.string.text1, R.string.text2, R.string.text3, R.string.text4, R.string.text5,R.string.unity,R.string.ps,R.string.sketch,R.string.ethical,R.string.python};
    private final String[] countries = {"Android (JAVA)", "iOS Development", "Android (KOTLIN)", "Web Development", "React Native","Unity 3D","Photoshop","Sketch UI/UX", "Ethical Hacking", "Python"};
...
//    private final String[] times = {"Aug 1 - Dec 15    7:00-18:00", "Sep 5 - Nov 10    8:00-16:00", "Mar 8 - May 21    7:00-18:00"};
    ...
    private final SliderAdapter sliderAdapter = new SliderAdapter(pics, countries.length, new OnCardClickListener());
...
//        temperatureSwitcher.setInAnimation(SignActivity.this, animH[0]);
//        temperatureSwitcher.setOutAnimation(SignActivity.this, animH[1]);
...
//        clockSwitcher.setInAnimation(SignActivity.this, animV[0]);
//        clockSwitcher.setOutAnimation(SignActivity.this, animV[1]);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == 0) {
                final Intent intent = new Intent(MainActivity.this, AndroidActivity.class);
            ...
            if (clickedPosition == 1) {
                final Intent intent = new Intent(MainActivity.this, IosActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 2) {
                final Intent intent = new Intent(MainActivity.this, KotlinActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 4) {
                final Intent intent = new Intent(MainActivity.this, ReactActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 5) {
                final Intent intent = new Intent(MainActivity.this, UnityActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 7) {
                final Intent intent = new Intent(MainActivity.this, SketchActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 8) {
                final Intent intent = new Intent(MainActivity.this, HackingActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
            ...
            if (clickedPosition == 9) {
                final Intent intent = new Intent(MainActivity.this, PythonActivity.class);
                //Toast.makeText(getApplicationContext(), ,Toast.LENGTH_SHORT).show();
                intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
